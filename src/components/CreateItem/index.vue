  ...
  <section>
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updateItem('itemForm')">Criar</el-button>
      </span>
    </el-dialog>
  </section>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: 'Por favor, insira o nome do item.', trigger: 'change' },
        ],
        class: [
          { required: true, message: 'Por favor, insira a categoria do item.', trigger: 'change' }
        ],
      },
      marks: {
        25: '25%',
